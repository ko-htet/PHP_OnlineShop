...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
					...
					<div class="col-lg-4 col-10">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						    ...
						    <a class="dropdown-item" href="order_history.php">Order History</a>
						  	<div class="dropdown-divider"></div>
						    <a class="dropdown-item" href="secret.php">Change Password</a>
						  	<div class="dropdown-divider"></div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="shopping_cart.php" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					<i class="icofont-shopping-cart"></i> 
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti amountitem"></span>
					<span class="totalamount"></span>
				</a>

				<a href="shopping_cart.php" class="text-decoration-none d-xl-none d-lg-none d-md-none d-sm-inline-block d-inline-block shoppingcartLink"> 
					<i class="icofont-shopping-cart"></i>
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti amountitem"></span>
				</a>
	...
	<div class="container subNav d-xl-block d-lg-block d-none my-3">
		<div class="row align-items-center">
                        ...
                        ?>
			          	<li class="dropdown-submenu">
				            ...
				            <ul class="dropdown-menu">
                                ...
                                <?php
                                    $q = "SELECT * FROM subcategories WHERE category_id = :v1";
                                    $stmt = $conn->prepare($q);
			...
			<div class="col-3">
				<a href="promotion_item.php" class="text-decoration-none text-dark font-weight-bold"> Promotion </a>
			</div>
			<div class="col-3">
			...
			<div class="col-3">
				<div class="hov-dropdown d-inline-block">
          			...
          			<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
            			...
            			<div class="dropdown-divider"></div>
            			<a class="dropdown-item" href="#">Returns & Refunds</a>
          			</div>
        		</div>
			</div>
		</div>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<?php } ?>
		  	...
		  	<a href="promotion_item.php"> Poromotion </a>
			<hr>
			...
			<?php 
				if(isset($_SESSION['login_user'])){ 
			?>
			<a data-toggle="collapse" href="#lginout" role="button" aria-expanded="false" aria-controls="lginout">
				<?= $_SESSION['login_user']['name']; ?>
		   		<i class="icofont-rounded-down float-right mr-3"></i>
		  	</a>
			<div class="collapse sidebardropdown_container_category mt-3" id="lginout">
				<a href="profile.php" class="py-2">Profile</a>
				<a href="order_history.php" class="py-2">Order History</a>
				<a class="py-2" href="secret.php">Change Password</a>
			...
			<a href="shopping_cart.php"> Cart [ <span class="cartNoti amountitem"> 0 </span> ]  </a>
			<hr>
