...
?>
	...
	<div class="jumbotron jumbotron-fluid subtitle">
  		<div class="container">
			<h1 class="text-center text-white" id="co_text"> Your Shopping Cart </h1>
  		</div>
	</div>
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tfoot id="shoppingcart_tfoot">
							<tr>
								<td colspan="8">
									<h3 class="text-right"> Total : <span class="totalamount"></span> </h3>
								</td>
							</tr>
							<tr> 
								<td colspan="5"> 
								...
								<td colspan="3">
									...
									?>
									<button class="btn btn-secondary btn-block mainfullbtncolor checkoutbtn"> Check Out </button>
									<?php } else{ $_SESSION['cartURL'] = 'shopping_cart.php'; ?>
