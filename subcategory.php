					...
					<a href="detail.php?id=<?= $itid ?>" class="text-decoration-none text-secondary">
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
							<div class="card pad15 mb-3">
								<a href="item_detail.php?id=<?= $itid; ?>" class="text-decoration-none text-secondary">
							  	...
							  	<div class="card-body text-center">
									...
									<button type="submit" class="btn btn-outline-info btn-sm AddtoCart" data-id="<?= $itid ?>"
										data-name="<?= $itname; ?>" data-photo="<?= $itphoto; ?>" data-price="<?= $itprice; ?>" data-discount="<?= $itdiscount; ?>">Add to Cart</button>
							  	</div>
							</div>
						</div>
					</a>
